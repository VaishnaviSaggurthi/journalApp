...
@Tag(name = "Journal Entry APIs", description = "APIs for journal entry operations with authentication") // Swagger tag -- used to group APIs in Swagger UI under a common name
public class JournalEntryControllerV2 {
    ...
    /* initial code -- without authentication
    @GetMapping("{userName}")
